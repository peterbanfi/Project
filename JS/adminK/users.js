...
function successAjax(xhttp) {
    ...
    */
    ...
    var headData = {
        full: ['#', 'Felhaszn.', 'Jelszó', 'Vezetéknév', 'Keresztnév',
            'Ország', 'Megye', 'Irányítósz.', 'Város', 'Cím', 'Nem', 'Születési d.',
            'Email', 'Tel.'
        ],
    ...
    document.getElementById("1990").addEventListener("click", function () {
        createTable(sort1900(userDatas), headData.b1990, dataProp.b1990);
    });
    document.getElementById("oldests").addEventListener("click", function () {
        createTable(sortbyAge(addAge(userDatas)), headData.oldest, dataProp.oldest);
    });
    document.getElementById("names").addEventListener("click", function () {
        createTable(showNames(userDatas), headData.names, dataProp.names);
    });
    document.getElementById("city").addEventListener("click", function () {
        createTable(showCity(userDatas), headData.city, dataProp.city);
    });
    document.getElementById("2000").addEventListener("click", function () {
        createTable(show2000(userDatas), headData.b2000, dataProp.b2000);
    });
...
function createTable(userData, head, props) {
    removeTable(document.getElementById('panel-body'));
